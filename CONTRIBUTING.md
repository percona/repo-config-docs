...
`percona-release` documentation is written in Markdown language, so you can 
...
3. Change the directory to ``repo-config-docs`` and add the remote upstream repository:
